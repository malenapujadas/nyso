...
<template>
  <section class="relative flex flex-col justify-center items-center text-center py-37 bg-[#f6f6eb] overflow-hidden">
    ...
    <img src="/logo.png" alt="Logo NYSO" class="w-75 mb-10 center relative z-10" />

    
    <h2
      class="text-[#4e0d05] font-extrabold text-3xl leading-tight max-w-3xl uppercase tracking-tight font-[Poppins] relative z-10"
    >
      DESCUBRIR,
...
<!-- SNysito -->
<section class="relative w-full bg-[#e099a8] text-[#4e0d05] py-15 px-8 flex flex-col md:flex-row items-center justify-center gap-10 overflow-hidden rounded-b-4xl ">
...
<!-- Sección 2 -->
<section
  class="relative w-full bg-[#3c490b] text-[#f6f6eb] py-14 px-10 flex flex-col md:flex-row items-center justify-center gap-6 overflow-hidden rounded-4xl"
>
  <!-- Iconos  -->
  <img src="/icono4.png" alt="Decoración" class="absolute top-10 right-40 w-16 rotate-12 opacity-100" />
  <img src="/icono4.png" alt="Decoración" class="absolute bottom-8 right-24 w-24 opacity-100" />
  <img src="/icono6.png" alt="Decoración" class="absolute bottom-16 left-1/5 w-28 opacity-100 -rotate-6" />
  <img src="/icono7.png" alt="Decoración" class="absolute bottom-2 left-1/3 w-28 opacity-100 rotate-12" />

  <!-- Texto -->
  <div class="text-right max-w-md z-10 md:mr-4">
    ...
    <RouterLink
      to="/social"
      class="inline-block px-8 py-3 text-lg font-semibold bg-[#e099a8] text-[#3c490b] border border-[#f6f6eb] rounded-full hover:bg-[#f6f6eb] hover:text-[#3c490b] transition-all duration-300"
    >
      Ver vinos
    </RouterLink>
  </div>
  ...
  <img
    ...
    class="w-72 md:w-[400px] z-10 bg-transparent md:ml-4"
  />
</section>

<!-- Sección 3 -->
<section
  class="relative w-full bg-[#f6f6eb] text-[#e099a8] py-14 px-10 flex flex-col md:flex-row items-center justify-center gap-6 overflow-hidden"
>
  <!-- Iconos decorativos -->
  ...
  <img
    src="/foto2.png"
    alt="Perfil de usuario NYSO"
    class="w-72 md:w-[400px] z-10 md:mr-4"
  />

  <!-- Texto -->
  <div class="text-left max-w-md z-10 md:ml-4">
    <p class="text-3xl font-extrabold leading-tight mb-6">
    ...
    <RouterLink
      to="/crear-cuenta"
      class="inline-block px-8 py-3 text-lg font-semibold bg-[#e099a8] text-[#3c490b] border border-[#4e0d05] rounded-full hover:bg-[#3c490b] hover:text-[#f6f6eb] transition-all duration-300"
    >
      Crear cuenta
    </RouterLink>
  </div>
...
<section class="w-full mb-0 pb-0">
  <img
    src="/KITMENS.png"
    alt="Banner KITMENS"
    class="w-full h-auto block object-cover mb-0 pb-0"
  />
</section>

<!-- Línea  -->
<section class="relative w-full h-20 bg-[#f6f6eb] mt-[-12px] overflow-hidden">
  <img 
    src="/lineacuadros.png" 
    alt="Divisor decorativo" 
