...
<template>
  ...
  <!-- Sección 2 -->
  <section
    class="relative w-full bg-[#3c490b] text-[#f6f6f6]
           py-12 px-6 md:py-14 md:px-10
  ...
  >
    ...
    <img src="/foto1.png" alt="Buscador de vinos" class="w-52 md:w-[380px] z-10 bg-transparent" />
  </section>

  <!-- Sección 3 -->
  <section
    class="relative w-full bg-[#f6f6eb] text-[#e099a8]
           py-12 px-6 md:py-14 md:px-10
           flex flex-col md:flex-row items-center justify-center 
