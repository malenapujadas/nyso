            ...
            >
              ...
              <div class="flex gap-3 items-center">
                ...
                <button
                  ...
                  class="text-xs sm:text-sm md:text-sm font-medium rounded-full px-4 py-2 border border-[#3c490b] text-[#3c490b] hover:bg-[#3c490b] hover:text-[#f6f6eb] transition-all duration-300"
                >
                  +Historial
                </button>
              </div>
