          ...
          >
            ...
            <div class="flex gap-3 items-center">
              ...
              <button
                ...
                class="text-xs sm:text-sm md:text-sm font-medium rounded-full px-4 py-2 bg-[#e099a8] text-[#3c490b] border border-[#f6f6eb]/60 hover:bg-[#3c490b] hover:text-[#f6f6eb] transition-all duration-300"
              >
                + Historial
              </button>
            </div>
